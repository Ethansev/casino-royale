...
export const THEMES: Readonly<Record<ThemeId, Theme>> = {
  pop: {
    ...
    scene: {
      ...
      floor: "#171234",
      ambient: 1.5,
      spot: { color: "#fff4dd", intensity: 600 },
      points: [
  ...
  neon: {
    ...
    scene: {
      ...
      floor: "#050507",
      ambient: 0.7,
      spot: { color: "#9be8ff", intensity: 450 },
      points: [
  ...
  walnut: {
    ...
    scene: {
      ...
      floor: "#120b07",
      ambient: 1.0,
      spot: { color: "#ffd9a0", intensity: 650 },
      points: [
  ...
  holo: {
    ...
    scene: {
      ...
      floor: "#02040a",
      ambient: 0.8,
      spot: { color: "#bdf3ff", intensity: 420 },
      points: [
  ...
  toon: {
    ...
    scene: {
      ...
      floor: "#0f1a2e",
      ambient: 1.6,
      spot: { color: "#ffffff", intensity: 500 },
      points: [
