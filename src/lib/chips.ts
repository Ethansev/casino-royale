...
export function chipStyle(denom: number): ChipStyle {
  if (denom >= 5000) return { fill: "#ea580c", stroke: "#7c2d12", text: "#fff" };
  if (denom >= 1000) return { fill: "#eab308", stroke: "#854d0e", text: "#1c1917" };
  if (denom >= 500) return { fill: "#e5e7eb", stroke: "#9ca3af", text: "#111827" };
