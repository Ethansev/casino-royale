...
export const metadata: Metadata = {
  title: "About — ChipCircle",
  description:
    "ChipCircle is a free social casino: real physics dice, real odds, no real money.",
};
...
export default function AboutPage() {
  return (
    <ContentPage eyebrow="About" title="A casino floor, minus the cash.">
      <p>
        ChipCircle is a free social casino. The dice are real physics, the odds
      ...
      <p>
        ChipCircle is for entertainment only. There is no real-money gambling and
